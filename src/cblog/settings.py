...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cxwv5go50qcd.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneshanifeblog' # please enter your s3 bucket name
